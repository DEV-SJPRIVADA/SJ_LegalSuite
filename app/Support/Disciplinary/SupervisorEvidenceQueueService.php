...

{
...

    {
        ...
        return $this->applyFieldEmployeeScope(
            ...
            DisciplinaryCase::query()
                ...
                ->where('notification_supervisor_user_id', $supervisor->id)
                ...
                ->with(['employee:id,first_name,last_name,document_number,municipality_code,employee_job_position_id', 'employee.employeeJobPosition:id,is_guarda']),
...

    {
        ...
        return $this->applyFieldEmployeeScope(
            ...
            DisciplinaryCase::query()
                ...
                ->where('decision_notification_supervisor_user_id', $supervisor->id)
...

    {
        ...
        return $query->whereHas('employee', fn (Builder $employee) => $this->scope->applyEmployeeScope($employee, $supervisor));
    ...
    private function formatNotificationSlot(mixed $date, ?string $shift, ?string $zone): string
