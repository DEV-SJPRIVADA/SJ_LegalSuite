...
- [x] FO-GJ-03 PDF multipágina estable: páginas Letter explícitas (`FoGj03DocumentPaginator`), encabezado HTML en cada hoja, sin `position:fixed` Dompdf
