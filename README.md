...
- [x] FO-GJ-03 diligenciado desde expediente (modal + PDF con firma; FO-GJ-44, FO-GJ-54 y FO-GJ-42 siguen solo plantilla en blanco)
- [ ] Exportación PDF de actuaciones con plantillas FO-GJ restantes desde el caso
- [ ] Vista Kanban "Mi pipeline" por abogado
- [ ] Tests Pest ampliados (parcial: `DisciplinaryCitationNotificationTest`, `FoGj03DraftTest`, `DisciplinaryLawyerPoolClaimTest`)
