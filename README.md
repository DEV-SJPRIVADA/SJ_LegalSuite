...
**Disciplinario — Etapa B (citación):** recorrido guiado en expediente (pasos 1–5) y bandeja **Coordinaciones** para planeación. **B.1:** `requestDiligenceDateProgramming()` + `proposed_slots` + confirmación de fecha. **B.2:** notificación física con supervisor. Cierre de coordinación validado (`CitationStageProgress`). Tests: `DisciplinaryCitationStageFlowTest.php`.
