                ...
                <div class="p-6">
                    @if ($activeTab === 'overview')
                        <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                            ...
                            @if ($case->current_status === \App\Enums\Disciplinary\CaseStatus::INFORME && ($case->agendaThread || Gate::allows('postAgendaLawyer', $case) || Gate::allows('postAgendaPlanning', $case)))
                                <div class="md:col-span-2 xl:col-span-3 rounded-xl border border-emerald-200 bg-emerald-50/50 p-5 space-y-4 dark:border-emerald-400/25 dark:bg-emerald-950/20"
                                    ...
                                    <div class="flex flex-wrap items-start justify-between gap-2">
                                        <div>
                                            <h4 class="text-xs uppercase tracking-wider text-emerald-800 font-semibold dark:text-emerald-200">Solicitud de agenda · Etapa A</h4>
                                            <p class="text-xs text-emerald-900/80 mt-1 dark:text-emerald-100/80">El abogado titular escribe la solicitud a planeación; cualquier usuario con rol planeación puede responder y adjuntar imágenes. Con al menos una respuesta de planeación podrá pasar el caso a <strong>citación (etapa B)</strong>.</p>
                                        </div>
                                    ...
                                    @elseif (Gate::allows('postAgendaLawyer', $case))
                                        <p class="text-xs text-gray-600 dark:text-slate-400">Aún no hay mensajes. Inicie el hilo con su primera solicitud.</p>
                                    @endif
                                    ...
                                    @can('postAgendaLawyer', $case)
                                        <div class="border-t border-emerald-200 pt-4 space-y-3 dark:border-white/10">
                                            ...
                                            <textarea wire:model="agendaLawyerBody" rows="3"
                                                ...
                                                placeholder="Solicitud de fechas / detalle para planeación…"></textarea>
                                    ...
                                    @if ($agendaGateBlocksCitacion ?? false)
                                        <p class="text-xs text-amber-800 bg-amber-50 ring-1 ring-amber-200 rounded-md px-3 py-2 dark:bg-amber-950/40 dark:text-amber-200 dark:ring-amber-500/30">
                                            Para usar <strong>Gestionar → Citación a diligencia</strong> debe existir al menos una respuesta de planeación en este hilo.
                                        </p>
                                    @endif
