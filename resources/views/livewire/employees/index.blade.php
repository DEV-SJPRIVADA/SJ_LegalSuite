        ...
        <div class="shrink-0 border-b border-slate-100 px-3 py-2 dark:border-white/10 sm:px-4">
            <div class="flex flex-col gap-2 lg:flex-row lg:items-center lg:gap-3">
                <div class="relative min-w-0 flex-1 overflow-hidden">
                    ...
                    <input type="text" inputmode="search" autocomplete="off" wire:model.live.debounce.350ms="search" placeholder="Buscar nombre, documento, email…" class="{{ $fieldCompact }} w-full pl-8" aria-label="Buscar empleados">
                </div>
